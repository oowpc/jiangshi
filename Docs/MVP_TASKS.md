...
- [x] Place command base, wall, and tower from data assets.
- [x] Deduct gold and wood when placing buildings.

## Phase 2: Units And Combat
...
## Phase 3: Waves And Win/Lose

- [x] Add wave warning and countdown UI.
- [x] Destroy command base to trigger defeat.
- [x] Survive the configured duration to trigger victory.
- Tune first 10-minute demo pacing.
